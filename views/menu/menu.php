  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle"  href="adminOrder.php"><span class="glyphicon glyphicon-signal"></span> Ordenes</a> <!-- data-toggle="dropdown"-->
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#"><span class="glyphicon glyphicon-check"></span> Ver Web</a></li>
