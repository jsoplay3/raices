...
class PedidoModel {
    ...
    public function insertarPedido(){
      ...
      '$this->mail_cliente', '$this->fecha_entrega_estimada', '$this->tipo_producto', '$this->cantidad', '$this->observaciones', '$this->estado',
      '$this->mensaje_tarjeta', '$this->tipo_pago', '$this->numero_comprobante', '$this->pago', '$this->fecha_pago', 
